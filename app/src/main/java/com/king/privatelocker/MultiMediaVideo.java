...
import com.king.privatelocker.adapter.AdapterMediaVideo;
...
public class MultiMediaVideo extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView lview = (ListView) findViewById(R.id.lyout_id);
        adapter = new AdapterMediaVideo(MultiMediaVideo.this,
                dataAdapterList, directory, fileList);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.remove:
                new AlertDialog.Builder(MultiMediaVideo.this)
